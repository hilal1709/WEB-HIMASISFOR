  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-6">
        ...
        <h2 className="text-2xl font-bold text-zinc-800">Tambah Galeri Prestasi Baru</h2>
        <p className="text-zinc-500 mt-1">Isi form di bawah untuk menambah galeri prestasi</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-md p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-3 pt-4 border-t border-zinc-200">
            ...
            >
              {uploading ? 'Mengupload...' : 'Simpan Galeri'}
            </button>
            <Link
              href="/admin/gallery"
