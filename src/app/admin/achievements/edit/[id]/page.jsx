...
export default function EditAchievementPage() {
  ...
  const fetchAchievement = async () => {
    try {
      ...
      if (data.success) {
        const achievement = data.data.find(item => item.id === parseInt(params.id))
        if (achievement) {
          setFormData(achievement)
          setImagePreview(achievement.image || '')
        } else {
          alert('Prestasi tidak ditemukan')
  ...
  return (
    <div className="max-w-4xl">
      <div className="mb-6">
        ...
        <h2 className="text-2xl font-bold text-zinc-800">Edit Prestasi</h2>
        <p className="text-zinc-500 mt-1">Update data prestasi di bawah</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-md p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-700 mb-2">Foto</label>
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-700 mb-2">Nama Orang *</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-700 mb-2">Nama Prestasi *</label>
            <input
              type="text"
          ...
          <div className="flex gap-3 pt-4 border-t border-zinc-200">
            ...
            >
              {uploading ? 'Mengupload...' : 'Update Prestasi'}
            </button>
            <Link
              href="/admin/achievements"
